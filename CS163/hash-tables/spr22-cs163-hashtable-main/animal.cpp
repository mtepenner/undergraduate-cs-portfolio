#include "program3.h"
/*I have functions here which function to individually display animals, copy data over efficiently,
and fill an animal with values the client enters in to dynamically allocate.*/
